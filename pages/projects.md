...
<ul class="posts">
    <p class="projects-group">Physics/Math</p>
    <li><span>A Fortran module for Vector Spherical Harmonics computations</span> &raquo; <a href="https://justinelfritz.github.io/pages/vsh.html">Fortran module for Vector Spherical Harmonics computations</a></li>
    <li><span>AWS Space Weather Analytics platform for data review and superposed epoch analysis</span> &raquo; <a href="https://justinelfritz.github.io/pages/aws_sw.html">AWS Space Weather Analytics</a></li>
    <p class="projects-group">Travel</p>
    ...
    <p class="projects-group">Personal Finance</p>
    ...
    <p class="projects-group">Recipes</p>
